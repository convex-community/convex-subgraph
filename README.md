...
- **curve-pools**: Indexes events around the Booster contract where users deposit their Curve LP tokens. Allows, for instance, to query a pool's historical TVL and APR, platform revenue breakdown & users' withdrawals and deposits. (<a href="https://thegraph.com/hosted-service/subgraph/convex-community/curve-pools">Live version</a>)
